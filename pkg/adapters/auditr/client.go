...
func (e *Client) StartWatching() error {
	return e.controller.Watch(source.Kind(e.manager.GetCache(), &v1alpha1.ConfigAuditReport{}, &handler.TypedFuncs[*v1alpha1.ConfigAuditReport, reconcile.Request]{
