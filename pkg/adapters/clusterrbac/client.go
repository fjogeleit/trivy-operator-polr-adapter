...
func (e *Client) StartWatching(ctx context.Context) error {
	return e.client.Watch(source.Kind(e.manager.GetCache(), &v1alpha1.ClusterRbacAssessmentReport{}, &handler.TypedFuncs[*v1alpha1.ClusterRbacAssessmentReport, reconcile.Request]{
