...
func (e *Client) StartWatching(ctx context.Context) error {
	return e.controller.Watch(source.Kind(e.manager.GetCache(), &v1alpha1.ClusterInfraAssessmentReport{}, &handler.TypedFuncs[*v1alpha1.ClusterInfraAssessmentReport, reconcile.Request]{
