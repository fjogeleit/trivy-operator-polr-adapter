...
func (p *PolicyReportClient) GenerateReport(ctx context.Context, report *v1alpha1.RbacAssessmentReport) error {
...
func (p *PolicyReportClient) DeleteReport(ctx context.Context, report *v1alpha1.RbacAssessmentReport) error {
	return retry.RetryOnConflict(retry.DefaultRetry, func() error {
